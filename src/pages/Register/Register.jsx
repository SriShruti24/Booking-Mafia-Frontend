    ...
    <div className="glass-panel rounded-3xl p-8 shadow-2xl space-y-6 w-full animate-in fade-in zoom-in-95 duration-200">
      ...
      <div className="text-center space-y-2">
        <div className="inline-flex items-center justify-center p-3 bg-accent/10 rounded-2xl text-accent mb-2">
          <Plane className="h-8 w-8 rotate-45 animate-pulse" />
        </div>
        <h2 className="font-display font-black text-2xl text-white uppercase tracking-wider">Register</h2>
        <p className="text-xs text-gray-500 font-semibold">Join Booking Mafia and enjoy seat selections</p>
      </div>
      ...
      <p className="text-center text-xs text-gray-500 font-semibold">
        ...
        <Link to="/login" className="text-accent underline hover:text-emerald-350 transition-colors">
          Sign In
        </Link>
      </p>
    </div>
